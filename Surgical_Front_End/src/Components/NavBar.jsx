    ...
    <div className="bg-white min-h-screen bg-no-repeat bg-cover bg-[url('./assets/hospitalBg.jpg')]">
      ...
      <div className="bg-teal-500 flex flex-col w-full h-fit absolute top-full mt-18">
        <div className="flex justify-around items-center w-1/2 absolute top-4 right-0">
          <h2 className=" right-3/4 ">Add More Data:</h2>
          <Link to="/Add">
          ...
          <h2 className=" right-3/4">Search User:</h2>
          <Link to="/search"><button className="relative border hover:border-sky-600 duration-500 group cursor-pointer text-sky-50  overflow-hidden h-14 w-40 rounded-md bg-green-800 p-2 flex justify-center items-center font-extrabold">
              ...
              <p className="z-10">Search User</p>
            </button></Link>
        </div>
        <h2 className="text-2xl font-bold ml-4 mt-[9%]">List of Hospitals:</h2>
